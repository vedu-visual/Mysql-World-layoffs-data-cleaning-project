...
-- BritishVolt looks like an EV company, wow raised like 2 billion dollars and went under
...
-- this is total layoffs as per Country
...
-- Total Lay offs by Industry type
SELECT industry, SUM(total_laid_off)
FROM world_layoffs.layoffs_staging2
GROUP BY industry
ORDER BY 2 DESC;

-- Total_layoffs_ over_the_years_By_industry_stage
